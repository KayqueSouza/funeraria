    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especie', models.CharField(choices=[('convencional', 'Convencional'), ('falta_falecer', 'Falta Falecer'), ('iml', 'IML')], default='convencional', max_length=14)),
                ...
                ('status', models.CharField(choices=[('aberto', 'Aberto'), ('executando', 'Executando'), ('fechado', 'Fechado')], default='aberto', max_length=22)),
            ],
            options={
                'abstract': False,
            },
